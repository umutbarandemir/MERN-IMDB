...
const TvShowPage = () => {
    ...
    useEffect(() => {
        const fetch = async () => {
            await fetchTvShowById(id);
            await fetchCommentsByTvShow(id);
        };
        fetch();
    }, [id,fetchTvShowById, fetchCommentsByTvShow]);
    ...
    if (error) return <p className="text-red-500 mt-16">{error}</p>;
                ...
                <section className="grid grid-cols-1 md:grid-cols-6 gap-6">
                    ...
                    <div className="md:col-span-3 space-y-6 bg-zinc-800 p-6 rounded-xl shadow-lg">
                        ...
                        <div className="flex gap-2 mt-4">
                            ...
                            <span className="ml-2 text-lg">{rating > 0 ? `You rated: ${rating}/5` : "Rate this show"}</span>
                        </div>
                    </div>
                </section>
