...
const MoviePage = () => {
    ...
    const { comments, fetchCommentsByMovie, addComment, toggleLike, loading: commentLoading } = useCommentStore();
                            ...
                            comments.map((c) => (
                                ...
                                >
                                    ...
                                    <button
                                        ...
                                        className={`flex items-center gap-1 text-sm select-none ${c.likedByUser ? "text-green-400" : "text-gray-400"} hover:text-green-500 transition`}
                                    >
